...
import com.textpicture.views.freetext.animation.A;
import com.textpicture.views.freetext.animation.Animation2IA;
import com.textpicture.views.freetext.animation.BaseAnimation2IA;
import com.textpicture.views.freetext.animation.ICanvasTransform;
import com.textpicture.views.freetext.animation.TA;
...
import com.textpicture.views.freetext.layer.ClipDrawer;
import com.textpicture.views.freetext.layer.FontStyle;
import com.textpicture.views.freetext.layer.ILayer;
import com.textpicture.views.freetext.layer.ImgLayer;
import com.textpicture.views.freetext.layer.LayerSpan;
import com.textpicture.views.freetext.layer.MultiLayer;
import com.textpicture.views.freetext.layer.OffsetDrawer;
import com.textpicture.views.freetext.layer.PaintHandler;
import com.textpicture.views.freetext.layer.SourceLoader;
import com.textpicture.views.freetext.layer.TxtLayer;
import com.textpicture.views.freetext.linedrawer.Gravity;
import com.textpicture.views.freetext.linedrawer.LineImgBackgroundDrawer;
import com.textpicture.views.freetext.linedrawer.LineImgForegroundDrawer;
import com.textpicture.views.freetext.util.CU;
...
//            setTextSize(TypedValue.COMPLEX_UNIT_PX,drawData.size);
    ...
    private SpannableStringBuilder buildString(final DrawData drawData, CharSequence content) {
        float width = drawData.width;
        float height = drawData.height == 0 ? 1.0f : drawData.height;
        LayerSpan span = new LayerSpan(height, width);
        SpannableStringBuilder builder = new SpannableStringBuilder(content);

        if (drawData.aniType != 0) {
