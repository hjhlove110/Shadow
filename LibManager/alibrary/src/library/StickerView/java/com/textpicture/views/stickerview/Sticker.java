...
import static com.dresses.library.utils.ExtKt.dp2px;
...
public abstract class Sticker {
    ...
    public void getBoundPoints(@NonNull float[] points) {
        ...
        float padding = dp2px(10);
        points[0] = points[0] - padding;
        points[1] = points[1] - padding;
        points[2] = points[2] + padding;
        points[3] = points[3] - padding;
        points[4] = points[4] - padding;
        points[5] = points[5] + padding;
        points[6] = points[6] + padding;
        points[7] = points[7] + padding;
    }
    ...
    public void setCenterV(int parentWidth, int parentHeight) {
        matrixValues[Matrix.MTRANS_X] = (parentWidth - trappedRect.width()) / 2f;
    }
