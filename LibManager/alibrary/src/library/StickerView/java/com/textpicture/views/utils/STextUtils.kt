...
import com.textpicture.views.freetext.view.STextView
import java.io.File
...
class STextUtils {
    ...
    companion object {
         ...
         * 设置投影的特效
         */
        fun setSpecialShadowStyle(textShadowStyleInfo: TextShadowStyleInfo, stext: STextView) {
         ...
         * 设置荧光特效
         */
        fun setSpecialStyle(drawData: DrawData, stext: STextView) {
         ...
         * @param gravity 排版方式
         */
        fun setGravity(gravity: Int, stext: STextView) {
         ...
         */
        fun setTextColor(textColor: String?, shadowColor: String?, stext: STextView) {
...
//                            })
        ...
        private fun setTypeFace(typefaceName: String, text: STextView?) {
            try {
