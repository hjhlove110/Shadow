...
public class TextSticker extends Sticker {
    ...
    public TextSticker setShadow(@ColorInt int color) {
        int radius = (int)dp2px(5);
        textPaint.setShadowLayer(radius > 20 ? 20 : radius, 0, 0, color);
        return this;
    }
    ...
    public TextSticker resizeText() {
        ...
        maxTextSize = targetTextSizePixels;
        staticLayout =
    ...
    public TextSticker resizeTextByChangeFont() {
