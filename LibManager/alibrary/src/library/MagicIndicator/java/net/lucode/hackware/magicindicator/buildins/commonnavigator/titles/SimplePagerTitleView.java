...
public class SimplePagerTitleView extends androidx.appcompat.widget.AppCompatTextView implements IMeasurablePagerTitleView {
    ...
    public void onSelected(int index, int totalCount) {
        ...
        if (mSelectedBg != 0) {
            setBackground(getResources().getDrawable(mSelectedBg));
        }
    }
    ...
    public void onDeselected(int index, int totalCount) {
        ...
        if (mNormalBg != 0) {
            setBackground(getResources().getDrawable(mNormalBg));
        }
    }
...
//        return 0;
    ...
    public int getmSelectedBg() {
        return mSelectedBg;
    }

    public void setmSelectedBg(@DrawableRes int mSelectedBg) {
        this.mSelectedBg = mSelectedBg;
    }
    ...
    public void setmNormalBg(@DrawableRes int mNormalBg) {
