...
public class HighlightOptions {
    ...
    public boolean clickHighLightDismiss;
    ...
    public static class Builder {
        ...
        /**
         * @param clickHighLightDismiss 点击highLight 区域引导页消失
         */
        public Builder setClickHighLightDismiss(boolean clickHighLightDismiss) {
            options.clickHighLightDismiss = clickHighLightDismiss;
            return this;
        }
        /**
