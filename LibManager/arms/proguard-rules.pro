...
################libaray###############
-keep class com.dresses.library.** { *; }
-keep class com.dresses.library.GlobalConfiguration { *; }
################support###############
...
-keep public class com.dressup.fun.R$*{
...
-keep class a.** {*;}
-keep class com.vivo.** {*;}
-keep public class com.nineton.dressupstory.R$*{
public static final int *;
}
...
# 透明状态栏
 ...
 -keep class cn.jpush.android.thridpush.oppo.OPushManager
