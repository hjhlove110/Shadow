...
public class RxLifecycleUtils {
    ...
    public static <T> LifecycleTransformer<T>bindUntilDestroyEvent(@NonNull final IView view){
        Preconditions.checkNotNull(view, "view == null");
        if (view instanceof ActivityLifecycleable) {
            return bindUntilEvent((ActivityLifecycleable) view, ActivityEvent.DESTROY);
        } else  if(view instanceof FragmentLifecycleable ){
            return bindUntilEvent((FragmentLifecycleable) view, FragmentEvent.DESTROY_VIEW);
