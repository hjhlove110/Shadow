...
public abstract class BaseDialogFragment<P extends IPresenter> extends DialogFragment implements IFragment, FragmentLifecycleable {
    protected final String TAGD = this.getClass().getSimpleName();
...
//        params.flags |= WindowManager.LayoutParams.FLAG_DIM_BEHIND;
            ...
            params.width = initWinWidth();
            params.height = initWinHeight();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (getDialog() != null) {
            Objects.requireNonNull(getDialog()).setCanceledOnTouchOutside(IsCancelable());
        }
        initViews();
    }
    ...
    public void showDialog(FragmentManager manager) {
        showAllowingStateLoss(manager, TAGD);
    }
